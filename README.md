...
I ran the same code in JDoodle online compiler.

Steps:
1. Go to the external libraries.
2. Import the gson package for handling the JSON files.
3. Add the testcases to the data.json file.
